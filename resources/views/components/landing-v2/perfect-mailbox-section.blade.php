...
<div class="bg-white py-16 lg:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Individuals Card -->
            <div
                class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 hover:shadow-xl transition-shadow cursor-pointer">
                <div class="text-center">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Individuals</h3>
            ...
            <!-- Small Teams Card -->
            <div
                class="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 hover:shadow-xl transition-shadow cursor-pointer">
                <div class="text-center">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Small Teams</h3>
                    <p class="text-gray-600 mb-6 leading-relaxed">
            ...
            <!-- Enterprises Card -->
            <div
                class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-8 hover:shadow-xl transition-shadow cursor-pointer">
                <div class="text-center">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Enterprises</h3>
                    <p class="text-gray-600 mb-6 leading-relaxed">
