    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                <div class="flex items-center mb-6">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-gray-600">Digital Nomad</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p class="text-gray-600 italic">
                    "The check deposit feature has saved me countless hours. I can deposit checks instantly without
                    visiting a bank. Highly recommended!"
                </p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                <div class="flex items-center mb-6">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-purple-400 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-xl">
                        E
                    </div>
                    <div class="ml-4">
                        <h3 class="text-lg font-semibold text-gray-900">Emily Rodriguez</h3>
                        <p class="text-gray-600">Remote Worker</p>
                    </div>
                </div>
                <div class="flex items-center mb-4">
                    <div class="flex text-yellow-400">
                ...
                <p class="text-gray-600 italic">
                    "Excellent customer service and reliable mail forwarding. The scanning feature is crystal clear and
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                <div class="flex items-center mb-6">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center text-white font-bold text-xl">
                        D
                    </div>
                    <div class="ml-4">
                ...
                <p class="text-gray-600 italic">
                    "Perfect for my startup. The virtual office address gives my business credibility and the mail
                    scanning saves me hours every week."
                </p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                <div class="flex items-center mb-6">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-teal-400 to-teal-600 rounded-full flex items-center justify-center text-white font-bold text-xl">
                        L
                    </div>
                    <div class="ml-4">
                ...
                <p class="text-gray-600 italic">
                    "The package forwarding service is incredibly fast and reliable. I've never had any issues with lost
                    or damaged packages."
                </p>
            </div>
