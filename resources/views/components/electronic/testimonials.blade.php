<section class="bg-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-50 rounded-2xl p-8">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">CFO, GrowthCorp</p>
                    </div>
                </div>
                <blockquote class="text-gray-700 italic">
                    "The integration with our accounting system is seamless. We've reduced our check processing time by
                    80% and eliminated manual errors. The ROI was immediate."
                </blockquote>
                <div class="flex mt-4">
                    <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                        <path
            ...
            <div class="bg-gray-50 rounded-2xl p-8">
                <div class="flex items-center mb-6">
                    <img src="{{ asset('assets/images/electronic-avatar-03.avif') }}" alt="Emily Rodriguez"
                        class="w-12 h-12 rounded-full mr-4">
                    <div>
                        <h4 class="font-semibold text-gray-900">Emily Rodriguez</h4>
                        <p class="text-sm text-gray-600">Operations Manager, ScaleUp</p>
                    </div>
                </div>
                <blockquote class="text-gray-700 italic">
                    "Customer support is outstanding. They helped us migrate from our old system seamlessly and provided
                    training for our entire team. Highly recommended!"
                </blockquote>
                <div class="flex mt-4">
                    <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                        <path
