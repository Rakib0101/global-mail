    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                Find articles that interest you most by browsing our categories.
            </p>
        </div>

        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <a href="{{ route('blog') }}" class="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
                <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mx-auto mb-4">
                    <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                    </svg>
                </div>
                <h3 class="font-semibold text-gray-900 mb-2">Virtual Mailbox</h3>
            ...
            <a href="{{ route('blog') }}" class="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
                ...
                <h3 class="font-semibold text-gray-900 mb-2">Lifestyle</h3>
