            ...
            <div class="flex gap-6 h-96 overflow-hidden">
                ...
                <div class="flex flex-col gap-6 animate-scroll-down integration-column">
                    ...
                    <div class="bg-white rounded-2xl shadow-md flex flex-col items-center justify-center p-6 min-w-[120px] min-h-[120px]">
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/trello/trello-original.svg" alt="Trello" class="w-10 h-10 mb-2">
                ...
                <div class="flex flex-col gap-6 animate-scroll-up integration-column">
                    <!-- First set -->
                    <div class="bg-white rounded-2xl shadow-md flex flex-col items-center justify-center p-6 min-w-[120px] min-h-[120px]">
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/salesforce/salesforce-original.svg" alt="Salesforce" class="w-10 h-10 mb-2">
                ...
                <div class="flex flex-col gap-6 animate-scroll-down-slow integration-column">
                    <!-- First set -->
                    <div class="bg-white rounded-2xl shadow-md flex flex-col items-center justify-center p-6 min-w-[120px] min-h-[120px]">
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/confluence/confluence-original.svg" alt="Confluence" class="w-10 h-10 mb-2">
                        <span class="text-gray-700 text-sm font-medium">Confluence</span>
                    </div>
                    <div class="bg-white rounded-2xl shadow-md flex flex-col items-center justify-center p-6 min-w-[120px] min-h-[120px]">
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/google/google-original.svg" alt="Google Meet" class="w-10 h-10 mb-2">
                        <span class="text-gray-700 text-sm font-medium">Google Meet</span>
                    </div>
                    <div class="bg-white rounded-2xl shadow-md flex flex-col items-center justify-center p-6 min-w-[120px] min-h-[120px]">
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/slack/slack-original.svg" alt="Slack" class="w-10 h-10 mb-2">
