                ...
                <div class="space-y-6">
                    <div class="space-y-4">
                        ...
                        <h2 class="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                            ...
                            <span class="text-primary">new member sign up.</span>
                        </h2>
                    </div>

                    <div class="pt-4">
                        <a href="{{ route('register') }}"
                           class="inline-flex items-center text-lg font-semibold text-primary hover:text-blue-700 transition-colors duration-200 group">
                            Get started today!
                ...
                <div class="relative flex justify-center lg:justify-end">
                    <div class="relative w-80 h-80">
                        ...
                        <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 w-64 h-32">
                            <div class="w-full h-full bg-gradient-to-b from-blue-400 to-primary rounded-full relative overflow-hidden">
                                <!-- Land masses -->
