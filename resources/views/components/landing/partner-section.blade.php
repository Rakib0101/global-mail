...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Rating Section -->
        <div class="text-center mb-12 flex justify-center items-center gap-4">
        ...
        <div class="overflow-hidden">
            ...
            <div class="flex space-x-12 mb-8 animate-scroll-right-to-left partners-row">
                ...
                <div class="text-green-500 font-bold text-2xl flex-shrink-0" style="font-family: 'Comic Sans MS', cursive;">
                    OLIPOP
                </div>
                <div class="text-center flex-shrink-0">
                    <div class="relative">
