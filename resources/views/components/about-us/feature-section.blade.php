    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col lg:flex-row items-center gap-12 mb-20">
            ...
            <div class="w-full lg:w-1/2 flex justify-center">
                <!-- 10+ Years Badge -->
                <div class="relative">
                    <div class="w-64 h-64 bg-gradient-to-br from-yellow-300 to-yellow-500 rounded-full flex items-center justify-center shadow-2xl">
                        <!-- Trophy Icon -->
        ...
        <div class="flex flex-col lg:flex-row-reverse items-center gap-12 mb-20">
            <div class="w-full lg:w-1/2">
                <h2 class="text-3xl md:text-4xl font-bold text-green-600 mb-6">
                    To help recycle 5,600,000 lbs pounds of junk mail every year
                </h2>
                <div class="text-lg text-gray-600 leading-relaxed space-y-4">
                    <p>
            ...
            <div class="w-full lg:w-1/2 flex justify-center">
                ...
                <div class="w-64 h-64 flex items-center justify-center">
                    <svg class="w-48 h-48 text-green-500" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M21.82 15.42l-1.75-3.03c-.74-1.28-1.96-2.24-3.42-2.68l1.75-3.03c.74-1.28.3-2.91-.98-3.64s-2.91-.3-3.64.98L12 6.67 10.22 4.02c-.74-1.28-2.37-1.71-3.64-.98s-1.71 2.37-.98 3.64l1.75 3.03c-1.46.44-2.68 1.4-3.42 2.68l-1.75 3.03c-.74 1.28-.3 2.91.98 3.64.43.25.92.38 1.42.38.89 0 1.76-.47 2.22-1.36L8.55 16h6.9l1.75 3.03c.46.8 1.28 1.24 2.12 1.24.5 0 1-.13 1.42-.38 1.28-.73 1.71-2.36.98-3.64L21.82 15.42zM9.8 13l1.4-2.42L12.6 13H9.8z"/>
                    </svg>
                </div>
            </div>
        </div>
                ...
                <div class="relative w-64 h-64">
                    <div class="w-full h-full bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center shadow-2xl">
                        ...
                        <div class="relative w-48 h-48">
                            <!-- North America -->
                            <div class="absolute top-8 left-12 w-16 h-12 bg-green-500 rounded-lg transform -rotate-12"></div>
                            <!-- South America -->
                            <div class="absolute top-20 left-16 w-8 h-16 bg-green-500 rounded-full transform rotate-12"></div>
                            <!-- Europe/Africa -->
                            <div class="absolute top-6 right-14 w-12 h-20 bg-green-500 rounded-2xl transform rotate-6"></div>
                            <!-- Asia -->
                            <div class="absolute top-4 right-8 w-14 h-14 bg-green-500 rounded-full"></div>
                            <!-- Australia -->
                            <div class="absolute bottom-12 right-12 w-8 h-6 bg-green-500 rounded-full"></div>
                        </div>
                    </div>
                    <!-- Clouds -->
                    <div class="absolute top-4 left-8 w-12 h-6 bg-white rounded-full opacity-80"></div>
                    <div class="absolute bottom-8 right-4 w-16 h-8 bg-white rounded-full opacity-80"></div>
                    <div class="absolute top-12 right-2 w-10 h-5 bg-white rounded-full opacity-80"></div>
                </div>
            </div>
        </div>
    </div>
