<section class="team-section py-16 bg-gray-50">
    <div class="container mx-auto px-4">
            ...
            <div class="flex justify-center items-center text-center mb-16">
                <div>
                    ...
                    <p class="text-lg text-gray-700 max-w-3xl mx-auto">
                        We are a core team of people who've come together to revolutionize the way we handle mail and in
                        the
                        process, leave a better world behind.
                    </p>
                </div>
            </div>
            <div class="">
                <img src="{{ asset('assets/images/about-us/second.jpeg') }}" alt="Team dinner gathering with wine"
                    class="w-full h-auto object-cover object-top">
            </div>
            <div class="flex flex-col lg:flex-col md:flex-row gap-6 justify-between">
                <img src="{{ asset('assets/images/about-us/first.jpeg') }}" alt="Team meeting around wooden table"
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="flex flex-col items-start gap-8">
                <!-- Quote icon -->
                <svg xmlns="http://www.w3.org/2000/svg" fill="#01a249" width="56" height="56"
                    viewBox="0 0 24 24">
                    <path
