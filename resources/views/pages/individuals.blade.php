...
@section('content')
    @include('components.individuals.hero-section')
    @include('components.individuals.problem-solution-section')
    @include('components.individuals.testimonials-grid-section')
    @include('components.individuals.access-mail-anywhere-section')
