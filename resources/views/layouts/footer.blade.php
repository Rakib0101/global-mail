<footer class="bg-gray-800 text-gray-300">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="flex items-center mb-4">
                    <div class="flex items-center">
                        <div class="w-8 h-8 bg-blue-600 rounded mr-2 flex items-center justify-center">
                            <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
                                <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/>
                            </svg>
                        </div>
                        <span class="text-blue-600 font-semibold text-lg">US Global Mail</span>
                    </div>
                </div>
                
                <!-- Address -->
                <p class="text-sm mb-4">1321 Upland Drive<br>Houston, TX 77043</p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-sm hover:text-white transition-colors">Property Management</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-sm hover:text-white transition-colors">Shipping Calculator</a></li>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="mb-4 md:mb-0">
                    <p class="text-sm">© 2025 USGM. All rights reserved.</p>
                </div>
    ...
    <div class="fixed bottom-6 right-6 z-50">
        <button class="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center shadow-lg hover:bg-blue-700 transition-colors">
