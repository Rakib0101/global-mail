            ...
            <div class="lg:col-span-1">
                ...
                <div class="flex items-center mb-12">
                    <div class="flex gap-0.5">
                        <svg class="size-6 text-[#ff8b00]" fill="currentColor" viewBox="0 0 20 20">
                            <path
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex space-x-3">
                    <!-- Facebook -->
                    <a href="#"
                        class="w-8 h-8 bg-primary rounded flex items-center justify-center hover:bg-blue-700 transition-colors">
                    ...
                    <!-- Twitter/X -->
                    <a href="#"
                        class="w-8 h-8 bg-black rounded flex items-center justify-center hover:bg-gray-800 transition-colors">
                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <!-- YouTube -->
                    <a href="#"
                        class="w-8 h-8 bg-red-600 rounded flex items-center justify-center hover:bg-red-700 transition-colors">
                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path
